...
$page_header = saaspik_option('saaspik_header_portfolio', true);
$page_header_img = saaspik_option('saaspik_header_image_portfolio');
...
$opt = saaspik_option('page_header_portfolio_style_main', 'partical_portfolio_main');



//$metapar  = isset( $meta['particle_animation']) ?  $meta['particle_animation'] : '';
$particle = saaspik_option('particle_animation_portfolio', true);




if( $opt == 'background_portfolio_main') { ?>
	<section class="page-banner header-bg-portfolio">
...
<!-- /.page-banner -->
<?php } elseif ( $opt == 'partical_portfolio_main') { ?>
