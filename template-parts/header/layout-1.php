...
$logo_main = saaspik_option('main_logo');
$logo_contrast = saaspik_option('sticky_logo' );
...
//Meta Logo
$logo = isset($meta['meta_main_logo']) ? $meta['meta_main_logo'] : '';
$meta_sticky_logo = isset($meta['meta_sticky_logo']) ? $meta['meta_sticky_logo'] : '';
...
<header id="masthead" class="site-header <?php $is_sticky_header = saaspik_option('header-sticky'); if( !empty($sticky_logo) && $is_sticky_header == '1' ) : echo 'header_trans-fixed'; endif; ?>"
	data-top="992">
