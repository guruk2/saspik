...
<header id="masthead" class="site-header header-five <?php $is_sticky_header = saaspik_option('header-sticky'); if( !empty($sticky_logo) && $is_sticky_header == '1' ) : echo 'header_trans-fixed'; endif; ?>"
	data-top="992">
		...
		<div class="header-inner">
			...
			<nav id="site-navigation" class="site-nav nav-two">
				...
				<div class="site-logo">
					<a href="<?php echo esc_url(home_url('/'));?>" class="logo">
						<?php if(!empty($meta_logo)): ?>						  
							<img src="<?php echo esc_url($meta_logo);  ?>" class="main-logo" alt="<?php echo esc_attr(bloginfo('name')); ?>">
							<?php if(!empty($meta_sticky_logo) && $is_sticky_header): ?>
								<img src="<?php echo esc_url($meta_sticky_logo);  ?>" alt="<?php echo esc_attr(bloginfo('name')); ?>" class="logo-sticky">
							<?php endif ?>						
						<?php else: 
