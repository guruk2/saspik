		...
		<div class="footer-wrapper">
			...
			<aside class="widget-area row">
				<?php
					...
					$area_1_column = get_theme_mod( 'saaspik_widget_area_1_column', 'col-lg-3' );
				...
				<?php }
					...
					$area_2_column = get_theme_mod( 'saaspik_widget_area_2_column', 'col-lg-3' );
				...
				<?php }
					...
					$area_3_column = get_theme_mod( 'saaspik_widget_area_3_column', 'col-lg-3' );
				...
				$area_3_display = get_theme_mod( 'saaspik_widget_area_4_display', true );
					$area_3_column = get_theme_mod( 'saaspik_widget_area_4_column', 'col-lg-3' );
